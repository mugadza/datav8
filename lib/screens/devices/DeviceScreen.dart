  ...
  Widget _channelCardGridLoaded(BuildContext context) {
    ...
    return (listChannelCardConfiguration.isEmpty) ? _emptyDeviceEvents() : StaggeredGridView.count(
      ...
      children: List.generate(
        ...
        (index) => ChannelCard(currentChannelConfiguration: listChannelCardConfiguration[index], otherChannelsConfigurations: listChannelCardConfiguration),
      ),
  ...
  void _buildListChannelCardConfiguration(){
    ...
    if(widget.device.ch1On){
      ...
      ChannelCardConfiguration channelCardConfiguration = ChannelCardConfiguration(
        ...
        unit: widget.device.unitsCh1,
        upperThreshold: widget.device.upperThresholdCh1,
        lowerThreshold: widget.device.lowerThresholdCh1,
        sensorType: widget.device.ch1SensorType,
        zeroOffset: widget.device.zeroOffsetCh1,
        scaleFactor: widget.device.scaleFactorCh1,
        name: widget.device.ch1Name,
        maskAlert: widget.device.ch1MasksAlerts,
        alertState: widget.device.alertStateCh1,
        chartColor: Colors.deepPurpleAccent,
    ...
    if(widget.device.ch2On){
      ...
      ChannelCardConfiguration channelCardConfiguration = ChannelCardConfiguration(
        ...
        statusColor: cardColor,
        unit: widget.device.unitsCh2,
        upperThreshold: widget.device.upperThresholdCh2,
        lowerThreshold: widget.device.lowerThresholdCh2,
        sensorType: widget.device.ch2SensorType,
        zeroOffset: widget.device.zeroOffsetCh2,
        scaleFactor: widget.device.scaleFactorCh2,
        maskAlert: widget.device.ch2MasksAlerts,
        alertState: widget.device.alertStateCh2,
        monitoringActive: widget.device.monitoringActiveCh2,
        name: widget.device.ch2Name,
        chartColor: Colors.limeAccent,
    ...
    if(widget.device.ch3On){
      ...
      ChannelCardConfiguration channelCardConfiguration = ChannelCardConfiguration(
        ...
        statusColor: cardColor,
        unit: widget.device.unitsCh3,
        upperThreshold: widget.device.upperThresholdCh3,
        lowerThreshold: widget.device.lowerThresholdCh3,
        sensorType: widget.device.ch3SensorType,
        zeroOffset: widget.device.zeroOffsetCh3,
        scaleFactor: widget.device.scaleFactorCh3,
        name: widget.device.ch3Name,
        chartColor: Colors.lightBlueAccent,
        latestChannelValue: firstNode.ch3.toStringAsFixed(4),
        maskAlert: widget.device.ch3MasksAlerts,
        alertState: widget.device.alertStateCh3,
    ...
    if(widget.device.ch4On){
      ...
      ChannelCardConfiguration channelCardConfiguration = ChannelCardConfiguration(
        ...
        statusColor: cardColor,
        unit: widget.device.unitsCh4,
        upperThreshold: widget.device.upperThresholdCh4,
        lowerThreshold: widget.device.lowerThresholdCh4,
        sensorType: widget.device.ch4SensorType,
        zeroOffset: widget.device.zeroOffsetCh4,
        scaleFactor: widget.device.scaleFactorCh4,
        ...
        maskAlert: widget.device.ch4MasksAlerts,
        alertState: widget.device.alertStateCh4,
        chartColorGradient: [cardColor.withOpacity(0.2), cardColor.withOpacity(0.01)],
    ...
    if(widget.device.ch5On){
      ...
      ChannelCardConfiguration channelCardConfiguration = ChannelCardConfiguration(
        ...
        statusColor: cardColor,
        unit: widget.device.unitsCh5,
        upperThreshold: widget.device.upperThresholdCh5,
        lowerThreshold: widget.device.lowerThresholdCh5,
        sensorType: widget.device.ch5SensorType,
